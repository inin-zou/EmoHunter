"use strict";(self.webpackChunkaura_vault_dapp=self.webpackChunkaura_vault_dapp||[]).push([[5283],{65283:(e,t,i)=>{i.r(t),i.d(t,{AppKitModal:()=>ye,W3mModal:()=>ge,W3mModalBase:()=>ve});var o=i(20443),a=i(73016),r=i(34618),s=i(22856),n=i(14889),c=i(40610),l=i(49176),w=i(32474),d=i(15049),p=i(13660),u=i(20714);const h={isUnsupportedChainView:()=>"UnsupportedChain"===p.I.state.view||"SwitchNetwork"===p.I.state.view&&p.I.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void c.W.shake();await u.U.isSIWXCloseDisabled()?c.W.shake():c.W.close()}};var m=i(8340),v=i(34367),g=i(12390),y=i(13816),f=i(90509),b=i(1046);const k=o.AH`
  :host {
    display: block;
